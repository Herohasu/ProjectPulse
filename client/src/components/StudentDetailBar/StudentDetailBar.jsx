        ...
        <div>
            ...
            <div className="std_details_contain">
                <div className="std_details1">
                    ...
                    <p>Enrollment No.: <a className='try'>210303108263</a></p>
                </div>
                <div className="std_details2">
                    <p>Project Name: <a className='try'>Project Pulse</a></p>
                    <p>Project Id: <a className='try'>002</a></p>
                </div>
                <div className="std_image">
                    <img src={profile_img} alt="student image"></img>
                </div>
            </div>
